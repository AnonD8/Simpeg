...
<head>
    <title>Daftar Jabatan - Sistem Informasi Kepegawaian</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        <a href="tambah_jabatan.php" class="btn-tambah">+ Tambah Jabatan</a>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="action-buttons">
                    <a href="ubah_jabatan.php?id=<?php echo $row['id_jabatan']; ?>" class="btn btn-ubah">Ubah</a>
                    <a href="hapus_jabatan.php?id=<?php echo $row['id_jabatan']; ?>"
                        onclick="return confirm('Yakin ingin menghapus jabatan ini?')" class="btn btn-hapus">Hapus</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </table>
